<template>
    <div id="gold">
        ...
        <div class="gold">
            ...
            <div class="gold-button" @click="$router.push('/my/gold/pay')">充值</div>
            <div class="gold-button gold-button1" style="margin-top:20px;" @click="$router.push('/my/gold/pay')">提现</div>
        </div>
    </div>
</template>
